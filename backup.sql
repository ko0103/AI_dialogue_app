...
DROP DATABASE "AI_dialogue_app_development";
DROP DATABASE "AI_dialogue_app_test";
...
CREATE ROLE "user";
ALTER ROLE "user" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md5b54b83771e46afa0f6c9752481067afe';
...
--
-- Database "AI_dialogue_app_development" dump
--
...
--
-- Name: AI_dialogue_app_development; Type: DATABASE; Schema: -; Owner: user
--

CREATE DATABASE "AI_dialogue_app_development" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';


ALTER DATABASE "AI_dialogue_app_development" OWNER TO "user";

\connect "AI_dialogue_app_development"
...
environment	development	2024-12-17 07:04:14.603961	2024-12-17 07:04:14.603961
\.
...
--
-- Database "AI_dialogue_app_test" dump
--
...
--
-- Name: AI_dialogue_app_test; Type: DATABASE; Schema: -; Owner: user
--

CREATE DATABASE "AI_dialogue_app_test" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';


ALTER DATABASE "AI_dialogue_app_test" OWNER TO "user";

\connect "AI_dialogue_app_test"
